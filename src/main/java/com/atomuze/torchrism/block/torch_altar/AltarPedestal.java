...
public class AltarPedestal extends BlockTileEntity<TileEntityTorchAltar> {

	public AltarPedestal(String name) {
	...
	@Override
	public AltarPedestal setCreativeTab(CreativeTabs tab) {
