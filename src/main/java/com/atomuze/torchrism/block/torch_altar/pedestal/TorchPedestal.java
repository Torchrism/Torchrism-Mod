...
public class TorchPedestal extends BlockTileEntity<TileEntityTorchAltar> {

	public TorchPedestal(String name) {
	...
	@Override
	public TorchPedestal setCreativeTab(CreativeTabs tab) {
