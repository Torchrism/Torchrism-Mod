...
public class AltarPurePedestal extends BlockTileEntity<TileEntityTorchAltar> {
	public AltarPurePedestal(String name) {
	...
	@Override
	public AltarPurePedestal setCreativeTab(CreativeTabs tab) {
