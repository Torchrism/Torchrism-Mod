...
public class TestRec  extends IForgeRegistryEntry.Impl<IRecipe> implements IRecipe {
	...
	public TestRec(ResourceLocation group, ItemStack result, ShapedPrimer primer) {
		this.group = group;
